...
const aboutSections = [
  {
    title: "Our Mission",
    content: "Rupaya is on a mission to revolutionize finance in South Asia through decentralized technology. We are committed to breaking down barriers to financial inclusion, creating opportunities for millions across the region, and fostering economic growth through blockchain innovation.",
    icon: RocketIcon,
  },
  {
    title: "Our Vision",
  ...
  },
  {
    ...
    content: "We prioritize the security of our users and their assets. Rupaya employs state-of-the-art security measures and adheres to best practices in blockchain security. We are also committed to regulatory compliance, working closely with authorities to ensure our services align with local and international financial regulations.",
    icon: ShieldIcon,
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={itemVariants} className={`mb-8 max-w-2xl mx-auto ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
            Be part of the movement that's reshaping South Asia's financial landscape. Whether you are an investor, developer, or simply curious about decentralized finance, there's a place for you in the Rupaya ecosystem.
          </motion.p>
